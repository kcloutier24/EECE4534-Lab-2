...
Lab 2
Issue 2: Busy Loop PWM

Use the busyWait function to create the timing.
Using the parameters calculated in the prelab to create a
PWM signal with a period of 1ms and a duty cycle of 50%.
Output the PWM signal to LED LD0.
*/
